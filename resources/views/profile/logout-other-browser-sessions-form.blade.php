<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Si es necesario, puedes desconectarte de todas tus otras sesiones iniciadas en otros dispositivos. A continuación se muestran algunas sesions recientes; sin embargo, esta lista puede no ser exhaustiva. Si sientes que la seguridad de tu cuenta ha sido comprometida, considera actualizar tu contraseña.
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled" class="bg-blue-900 hover:bg-blue-600">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2 bg-red-700 hover:bg-red-500"
