...
<div class="card w-50 mx-auto">
    <div class="card-body">
        {!! Form::model($report,['route' => ['admin.reports.index', ], 'method' => 'put']) !!}
        ...
        <a href="{{route('admin.reports.download-pdf')}}" class="btn btn-success float-right ml-2">Generar PDF</a>
        {{-- <a href="{{route('admin.reports.make-excel')}}" class="btn btn-success float-right">Generar Excel</a> --}}
