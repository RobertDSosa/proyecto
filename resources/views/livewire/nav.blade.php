      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <a href="/" class="flex-shrink-0 flex items-center">
            <img class="block lg:hidden h-16 w-auto rounded-full py-2 px-2" src="{{URL::asset('/images/logo.png')}}" alt="Centro Cristiano">
            <img class="hidden lg:block h-16 w-auto rounded-full py-2 px-2" src="{{URL::asset('/images/logo.png')}}" alt="Centro Cristiano">
          </a href="/">
            ...
            <div class="flex space-x-4 space-y-4">
              ...
              {{-- <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a> --}}
                @foreach ($categories as $category)
                    <a href="{{route('posts.category', $category)}}" class="flex space-x-4 space-y-4 text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$category->name}}</a>
                @endforeach
            </div>
          </div>
        </div>
